...
public class ChatAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = vi.inflate(R.layout.list_chat_item, null);
        ...
        boolean myMsg = chatMessage.isSelfMessage() ;
    ...
    private void setAlignment(ViewHolder holder, boolean selfMessage) {
        if (selfMessage) {
            holder.contentWithBG.setBackgroundResource(R.drawable.blue_message_bubble);
            ...
            holder.contentWithBG.setBackgroundResource(R.drawable.gray_message_bubble);
